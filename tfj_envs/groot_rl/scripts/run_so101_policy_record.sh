...
POLICY_PATH="${POLICY_PATH:-/data/tfj/lerobot_tfj/outputs/train/smolvla_hybrid_aloha_live_20260316_111221/checkpoints/last/pretrained_model}"
...
echo "Backend: policy_record"
echo "Bundle root: ${BUNDLE_ROOT}"
echo "Project root: ${PROJECT_ROOT}"
echo "Runtime root: ${RUNTIME_ROOT}"
echo "Guarded entrypoint: ${ENTRYPOINT}"
echo "Task text: ${TASK_TEXT}"
echo "Dataset root: ${DATASET_ROOT}"
echo "Clear dataset root: ${CLEAR_DATASET_ROOT}"
