...
TASK_TEXT="${TASK_TEXT:-${TASK:-Pick up the target object}}"
...
DATASET_REPO_ID="${DATASET_REPO_ID:-local/eval_pi05_so101}"
DATASET_ROOT="${DATASET_ROOT:-./outputs/eval_pi05_so101}"
...
echo "Tokenizer path: ${PALIGEMMA_LOCAL_TOKENIZER_PATH}"
